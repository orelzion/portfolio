    ...
    <section className="py-12 md:py-20" itemScope itemType="https://schema.org/Person">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-xl md:text-2xl font-medium text-[var(--accent-color)] mb-4 transition-colors duration-300" itemProp="jobTitle">
            {config.tagline}
          </p>
          ...
          {/* Location Badge */}
          <div className="flex justify-center md:justify-start mb-6" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
